<div class="card card-primary card-solid mt-3">
	...
	<div class="card-body pb-0">
		<div class="form-group row">
			...
			<?php if(isset($preguntas_sin_responder) && !$preguntas_sin_responder): ?>
				<div class="col-lg-12">
					<div class="card">
										...
										<tr>
											...
											<td class="text-center">
												<div class="custom-control custom-radio">
													<input class="custom-control-input" id="respuesta_<?=$cpe->id_cat_preguntas_encuesta?>_1" type="radio" data-rule-required="true" 
													name="respuesta[<?=$cpe->id_cat_preguntas_encuesta?>]" value="1" <?=isset($cpe->respuesta) && $cpe->respuesta == 1 ? 'checked="checked"':''?> >
													<label for="respuesta_<?=$cpe->id_cat_preguntas_encuesta?>_1" class="custom-control-label col-sm-1"></label>
												</div>
											</td>
											<td class="text-center">
												<div class="custom-control custom-radio">
													<input class="custom-control-input" id="respuesta_<?=$cpe->id_cat_preguntas_encuesta?>_2" type="radio" 
													name="respuesta[<?=$cpe->id_cat_preguntas_encuesta?>]" value="2" <?=isset($cpe->respuesta) && $cpe->respuesta == 2 ? 'checked="checked"':''?>>
													<label for="respuesta_<?=$cpe->id_cat_preguntas_encuesta?>_2" class="custom-control-label"></label>
												</div>
											</td>
											<td class="text-center">
												<div class="custom-control custom-radio">
													<input class="custom-control-input" id="respuesta_<?=$cpe->id_cat_preguntas_encuesta?>_3" type="radio" 
													name="respuesta[<?=$cpe->id_cat_preguntas_encuesta?>]" value="3" <?=isset($cpe->respuesta) && $cpe->respuesta == 3 ? 'checked="checked"':''?>>
													<label for="respuesta_<?=$cpe->id_cat_preguntas_encuesta?>_3" class="custom-control-label"></label>
												</div>
											</td>
											<td class="text-center">
												<div class="custom-control custom-radio">
													<input class="custom-control-input" id="respuesta_<?=$cpe->id_cat_preguntas_encuesta?>_4" type="radio" 
													name="respuesta[<?=$cpe->id_cat_preguntas_encuesta?>]" value="4" <?=isset($cpe->respuesta) && $cpe->respuesta == 4 ? 'checked="checked"':''?>>
