...
var PerfilAdmin = {
	...
	modal_modificar_usr : function(id_usuario){
		Comun.obtener_contenido_peticion_html(base_url + 'Usuario/agregar_modificar_usuario/admin_emp/' + id_usuario,
			{},
			function(response){
	...
	guardar_usuario : function(id_usuario = ''){
		...
		if(PerfilAdmin.validar_form_usuario()){
			Comun.enviar_formulario_post(
				...
				base_url + 'Usuario/guardar_form_usuario/admin_emp/' + id_usuario,
				function(response){
					if(response.success){
